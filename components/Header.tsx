            ...
            <div className="flex justify-between items-center mx-auto max-w-7xl">
                ...
                >
                 ...
                 <nav className="hidden md:flex items-center space-x-6 font-medium">
                     ...
                     <motion.a href="#" onClick={(e) => handleNavigation(e, 'projects')} className={`text-gray-400 transition-colors duration-300 tracking-wider ${activePage === 'projects' || activePage === 'designer' ? 'text-amber-400' : ''}`} whileHover={{ scale: 1.1, color: '#FFC107' }} whileTap={{ scale: 0.9 }}>PROJECTS</motion.a>
