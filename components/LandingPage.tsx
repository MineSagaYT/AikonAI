...
const LandingPage: React.FC<LandingPageProps> = ({ onStart }) => {
    return (
        <div className="relative min-h-screen font-sans text-[#1E293B] bg-[#F8FAFC]">
            ...
            {/* Navigation */}
            <nav className="fixed top-0 w-full z-50 nav-glass transition-all duration-300 border-b border-slate-200/50">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2 cursor-pointer" onClick={() => window.scrollTo(0, 0)}>
                        ...
                        <span className="font-heading text-2xl font-bold tracking-tight">Aikon<span className="text-brand-600">Ai</span></span>
                    </div>
            ...
            <section className="min-h-screen flex flex-col items-center justify-center pt-24 px-4 relative">
                <div className="text-center max-w-4xl z-10 animate-fade-up">
                    ...
                    <h1 className="font-heading text-6xl md:text-8xl font-bold leading-[1.1] mb-6 tracking-tight">
                        Your Idea. <br />
            ...
            <section id="features" className="py-24 px-6 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        <div key={i} className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition duration-300">
                            <div className={`w-14 h-14 rounded-2xl bg-${feat.color}-50 text-${feat.color}-600 flex items-center justify-center text-3xl mb-6`}>
                    ...
                    <div className="rounded-2xl p-8 flex flex-col items-center justify-center text-center bg-gradient-to-br from-brand-600 to-accent-500 text-white cursor-pointer hover:shadow-2xl transition shadow-lg" onClick={onStart}>
                    ...
                    <div>
                     ...
                     <div>
                        ...
                        <div className="flex gap-4">
                            <a href="#" className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-text-muted hover:bg-brand-600 hover:text-white transition"><i className="ph-fill ph-twitter-logo"></i></a>
                            <a href="#" className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-text-muted hover:bg-brand-600 hover:text-white transition"><i className="ph-fill ph-instagram-logo"></i></a>
                        </div>
                    </div>
                </div>
