    ...
    return (
        ...
        >
            <section className="text-center py-16 md:py-24">
                ...
                {/* --- NEW HERO: AIKON DESIGNER --- */}
                <motion.div variants={itemVariants} className="mb-16">
                    <div className="relative group overflow-hidden rounded-3xl border-2 border-amber-500/50 bg-gradient-to-br from-[#1e1e1e] to-black p-1 shadow-2xl hover:shadow-[0_0_60px_rgba(255,193,7,0.2)] transition-all duration-500">
                         <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-20"></div>
                         <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 p-8 md:p-12">
                            <div className="flex-1 text-left space-y-6">
                                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/20 border border-amber-500/50 text-amber-400 text-xs font-bold tracking-wider uppercase">
                                    <span className="w-2 h-2 rounded-full bg-amber-400 animate-pulse"></span>
                                    New Flagship Product
                                </div>
                                <h3 className="text-4xl md:text-5xl font-black text-white leading-tight">
                                    Aikon <span className="text-amber-400">Designer</span>
                                </h3>
                                <p className="text-lg text-gray-300 leading-relaxed">
                                    An advanced <strong>AI-Integrated Development Environment (IDE)</strong>. Unlike simple chatbots, Aikon Designer architects full-stack multi-file projects, manages virtual file systems, and renders live previews instantly. It's not just code generation; it's <strong>software engineering</strong>.
                                </p>
                                <div className="flex flex-wrap gap-4 pt-2">
                                    <motion.button 
                                        onClick={() => navigateTo('designer')} 
                                        className="px-8 py-4 bg-amber-500 text-black font-bold text-lg rounded-xl shadow-lg hover:bg-amber-400 hover:scale-105 transition-all duration-300 flex items-center gap-3"
                                        whileTap={{ scale: 0.95 }}
                                    >
                                        <span>🚀</span> Launch Designer
                                    </motion.button>
                                    <div className="flex items-center gap-4 px-4 py-2 rounded-lg bg-white/5 border border-white/10">
                                        <div className="flex -space-x-2">
                                            <div className="w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center text-xs font-bold">TS</div>
                                            <div className="w-8 h-8 rounded-full bg-cyan-500 flex items-center justify-center text-xs font-bold">R</div>
                                            <div className="w-8 h-8 rounded-full bg-purple-500 flex items-center justify-center text-xs font-bold">V</div>
                                        </div>
                                        <span className="text-xs text-gray-400">React • TypeScript • Tailwind</span>
                                    </div>
                                </div>
                            </div>
                            <div className="flex-1 w-full md:w-auto relative">
                                {/* Mock Interface Graphics */}
                                <div className="relative rounded-xl overflow-hidden border border-gray-700 shadow-2xl bg-[#0d0d0d] aspect-video group-hover:scale-[1.02] transition-transform duration-500">
                                    <div className="h-6 bg-[#1f1f1f] border-b border-gray-700 flex items-center px-3 gap-2">
                                        <div className="w-3 h-3 rounded-full bg-red-500"></div>
                                        <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
                                        <div className="w-3 h-3 rounded-full bg-green-500"></div>
                                    </div>
                                    <div className="flex h-full">
                                        <div className="w-1/4 border-r border-gray-800 p-2 space-y-2 bg-[#111]">
                                            <div className="h-2 w-16 bg-gray-700 rounded opacity-50"></div>
                                            <div className="h-2 w-20 bg-gray-700 rounded opacity-30"></div>
                                            <div className="h-2 w-12 bg-gray-700 rounded opacity-30"></div>
                                        </div>
                                        <div className="w-3/4 p-4 font-mono text-[10px] text-gray-400 space-y-1">
                                            ...
                                            <p><span className="text-purple-400">const</span> <span className="text-yellow-400">App</span> = () ={'>'} {'{'}</p>
                                            <p className="pl-4"><span className="text-purple-400">return</span> (</p>
                                            <p className="pl-8">{'<'}<span className="text-red-400">div</span> className=<span className="text-green-400">"p-4"</span>{'>'}</p>
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-[#0d0d0d] to-transparent opacity-50"></div>
                                    <div className="absolute bottom-4 right-4 px-3 py-1 bg-amber-500 text-black text-xs font-bold rounded shadow-lg">
                                        Live Preview Active
                                    </div>
                                </div>
                            </div>
