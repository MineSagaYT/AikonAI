...
export const createPptxFile = async (data: PresentationData, topic: string): Promise<void> => {
    try {
        ...
        pptx.defineSlideMaster({
            ...
            objects: [
                { 'text': {
                    ...
                    options: { x: 0.5, y: 5.2, w: '90%', h: 0.25, fontFace: 'Kanit', fontSize: 10, color: 'A9A9A9', align: 'center' }
                }},
                { 'placeholder': {
                    options: { name: 'body', type: 'body', x: 0.5, y: 1.5, w: '90%', h: 3.5, fontFace: 'Kanit', fontSize: 16, color: AIKON_TEXT_COLOR, bullet: true },
                    text: '(Content)'
                }}
            ],
            slideNumber: { x: 9.5, y: 5.3, fontFace: 'Kanit', fontSize: 10, color: 'A9A9A9' },
        });
        ...
        titleSlide.addText(topic, {
            x: 0.5, y: 2, w: '90%', h: 1,
            fontFace: 'Kanit', fontSize: 44, bold: true, color: AIKON_PRIMARY_COLOR, align: 'center'
        });
        titleSlide.addText(`A presentation by Aikon Studios`, {
            x: 0.5, y: 3.2, w: '90%', h: 0.5,
            fontFace: 'Kanit', fontSize: 18, color: AIKON_TEXT_COLOR, align: 'center'
        });
        ...
        for (const slideData of data.slides) {
            ...
            slide.addText(slideData.title, {
                ...
                fontFace: 'Kanit', fontSize: 28, bold: true, color: AIKON_PRIMARY_COLOR
            });
